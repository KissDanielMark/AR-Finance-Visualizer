...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzo}{Kiss Dániel Márk}
\newcommand{\vikkonzulens}{Dóka János}
\newcommand{\vikcim}{Augmenteted reality using ARKit}
\newcommand{\viktanszek}{Távközlési És Médiainformatikai Tanszék}
\newcommand{\vikdoktipus}{Önálló laboratórium 1}
\newcommand{\vikdepartmentr}{Távközlési És Médiainformatikai Tanszék}
